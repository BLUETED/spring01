                        ...
                        <table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center" valign="bottom" background="${pageContext.request.contextPath}/images/loginbg.gif">
                                    <s:form namespace="/user" action="login" id="loginAction_home" name="form1" target="_parent">
                                        <table border="0" align="center" cellpadding="2" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <s:textfield name="logonName" id="logonName" class="text" style="width: 160px;"></s:textfield>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td height="30" nowrap>
                                                ...
                                                <td>
                                                    <s:password name="logonPwd" id="logonPwd" class="text" style="width: 160px;"></s:password>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <s:submit value="登录" class="buttoninput"></s:submit>
